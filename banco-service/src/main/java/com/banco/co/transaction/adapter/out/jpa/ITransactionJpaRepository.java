 ...
 * Package-private: only TransactionJpaAdapter should access this directly.
 * JPQL FROM clause uses TransactionEntity (not legacy Transaction).
 */
interface ITransactionJpaRepository extends JpaRepository<TransactionEntity, UUID> {
    ...
    @Query("SELECT t FROM TransactionEntity t " +
            ...
            "WHERE t.id = :id")
    Optional<TransactionEntity> findByIdWithAccounts(@Param("id") UUID id);
    ...
    List<TransactionEntity> findAllByAccountCode(@Param("accountCode") String accountCode);
    ...
    @Query("SELECT DISTINCT t FROM TransactionEntity t " +
            ...
            "ORDER BY t.createdAt DESC")
    List<TransactionEntity> findAllByFromAccountCode(@Param("accountCode") String accountCode);
    ...
    @Query("SELECT DISTINCT t FROM TransactionEntity t " +
            ...
            "ORDER BY t.createdAt DESC")
    List<TransactionEntity> findAllByToAccountCode(@Param("accountCode") String accountCode);
    ...
    @Query(value = "SELECT t FROM TransactionEntity t " +
            ...
            "AND (:startDate IS NULL OR t.createdAt >= :startDate) " +
            "AND (:endDate IS NULL OR t.createdAt <= :endDate)")
    Page<TransactionEntity> findUserTransactions(
    ...
    List<TransactionEntity> findByCategory(@Param("category") TransactionCategory category);
    ...
    @Query("SELECT DISTINCT t FROM TransactionEntity t " +
            ...
            "ORDER BY t.createdAt DESC")
    List<TransactionEntity> findByCategoryAndUser(
            @Param("category") TransactionCategory category,
            @Param("userId") UUID userId
    );
    ...
    List<TransactionEntity> findByFlaggedForFraudTrue();
    ...
    List<TransactionEntity> findSuspiciousTransactions();
    ...
    List<TransactionEntity> findPendingScheduledTransactions(@Param("now") LocalDateTime now);
    ...
    @Query("SELECT t FROM TransactionEntity t WHERE " +
            ...
            "ORDER BY t.createdAt DESC")
    @Transactional(readOnly = true)
    Page<TransactionEntity> findAccountTransactionsByUser(
            @Param("accountCode") String accountCode,
            @Param("userId") UUID userId,
            @Param("type") TransactionType type,
            @Param("status") TransactionStatus status,
    ...
    @Query("SELECT t FROM TransactionEntity t " +
            "LEFT JOIN FETCH t.fromAccount fa LEFT JOIN FETCH fa.user " +
            "WHERE t.id = :id")
    Optional<TransactionEntity> findByIdWithFromAccount(@Param("id") UUID id);
}
