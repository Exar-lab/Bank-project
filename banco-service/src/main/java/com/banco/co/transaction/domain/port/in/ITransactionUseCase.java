package com.banco.co.transaction.domain.port.in;
...
/**
 * Input port — use cases exposed by the transaction domain.
 * NO JPA imports, NO Spring Data JPA imports.
 * Page/Pageable from spring-data-commons are allowed (pagination abstraction, not JPA).
 * Implementations live in the application layer (TransactionService).
 */
